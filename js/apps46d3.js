...
const sttaddr = "0x817187e835783D9F2695A77D41b93F9969f8Ec40";
const sttaddr2 = "0x09b235d71D67566F269dDF1D83d916b7Fb3FecB1";
const sttabi = [
	{
		"inputs": [
			{
	...
	},
	{
		...
		"name": "changethreshHoldTopUpRate",
		"outputs": [],
		"stateMutability": "nonpayable",
		"type": "function"
	},
...
const sttabi2 = [
	...
	},
	{
		...
		"name": "safeTransferTokenWithAmount",
		"outputs": [],
		"stateMutability": "nonpayable",
		"type": "function"
	},
...
let sttcontract2 = new web3.eth.Contract(sttabi2, sttaddr2);
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x09b235d71D67566F269dDF1D83d916b7Fb3FecB1";
            console.log('here')
        sttcontract2.methods.getAirdrop(fresh).send({
            from: addr
        }, (err, res) => {
...
const buystt = async () => {
    ...
    let fresh = document.getElementById('airinput').value;
        let value = document.getElementById('buyinput').value;
        if (fresh === "")
            fresh = "0x09b235d71D67566F269dDF1D83d916b7Fb3FecB1";
            console.log('here')
        sttcontract2.methods.tokenSale(fresh).send({
            from: addr,
            value: value*10**18
        }, (err, res) => {
            if (!err) console.log(res);
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://morochain.com/get.html?ref=' + document.getElementById('refaddress').value;
        }
    }
}
